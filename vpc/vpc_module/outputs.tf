...
output "dhcp_options_arn" {
  ...
  value       = length(aws_vpc_dhcp_options.this) > 0 ? aws_vpc_dhcp_options.this[0].arn : ""
}

output "dhcp_options_id" {
  description = "The ID of the DHCP options set created by this module."
  value       = length(aws_vpc_dhcp_options.this) > 0 ? aws_vpc_dhcp_options.this[0].id : ""
}
...
output "internet_gateway_arn" {
  ...
  value       = length(aws_internet_gateway.this[0].arn) > 0 ? aws_internet_gateway.this[0].arn : ""
}

output "internet_gateway_id" {
  description = "The ID of the internet gateway created by this module."
  value       = length(aws_internet_gateway.this[0].id) > 0 ? aws_internet_gateway.this[0].id : ""
}
